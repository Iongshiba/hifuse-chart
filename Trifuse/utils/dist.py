...
#
# Modified dist.py for my project’s DDP launcher
# Original code:
#   © 2024 Ultralytics IP LTD. https://github.com/ultralytics/ultralytics
...
if __name__ == "__main__":
    ...
    cfg = load_config(DEFAULT_CONFIG_FILE, overrides)
    trainer = {name}(cfg)
